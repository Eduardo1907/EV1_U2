...
namespace MercDevs_ej2.Controllers
{
    public class RecepcionequipoesController : Controller
    {
        ...
        public async Task<IActionResult> RecepcionEquiposPorCliente(int? id_cliente)
        {
            if (id_cliente == null)
            {
                return NotFound();
            ...
            var recepcionEquipos = await _context.Recepcionequipos
                .Include(r => r.IdClienteNavigation)
                .Include(r => r.IdServicioNavigation)
                .Where(u => u.IdCliente == id_cliente)
                .ToListAsync();

            return View(recepcionEquipos);
        }
        ...
        public async Task<IActionResult> CambiarEstado(int id)
        {
            ...
            // Cambiar el estado aquí según la lógica deseada
            recepcionEquipo.Estado = recepcionEquipo.Estado == 1 ? 0 : 1;
            ...
            //llamo al nombre del valor que quiero atribuir, y luego llamo al mismo valor, asi lo asigno a mi diccionario
    {
        ...
        { nameof(recepcionequipo.Estado), recepcionequipo.Estado }
            ...
            //o quiza lo mejor sea agregar la fecha desde e  sistema del pc, seria lo mas acertado 
